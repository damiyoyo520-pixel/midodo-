  ...
  <div class="zone-page">
    ...
    <nav class="top-nav">
      <div class="nav-container">
        ...
        <div class="nav-center">
          ...
          <router-link to="/zone/global" class="nav-link active">海外专区</router-link>
    ...
    <section class="section scripts-section">
      <div class="section-header">
        <h2 class="section-title">海外剧本</h2>
    ...
    <section class="stats-bar">
      <div class="stats-container">
        <div class="stat-item">
          ...
          <span class="stat-label">海外剧本</span>
        </div>
        ...
        <div class="stat-item">
          ...
          <span class="stat-label">海外创作者</span>
        </div>
      </div>
    </section>
...
const scripts = ref([
  ...
  },
  {
    ...
    price: 379,
    rating: 4.8,
    image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Paris%20Eiffel%20Tower%20romantic%20silhouette%20golden%20sunset%20Hollywood%20movie%20poster%20cinematic&image_size=portrait_4_3'
  },
  {
    id: '10',
    title: '新加坡梦',
    ...
    price: 299,
    rating: 4.5,
    image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Singapore%20city%20skyline%20modern%20skyscrapers%20business%20elite%20Hollywood%20movie%20poster&image_size=portrait_4_3'
  }
])
</script>
